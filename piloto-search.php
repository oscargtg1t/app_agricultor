	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-search fa-fw"></i> &nbsp; PILOTOS
				</h3>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a href="piloto-new.html"><i class="fas fa-plus fa-fw"></i> &nbsp; REGISTRAR PILOTO</a>
					</li>
					<li>
						<a href="piloto-list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE PILOTOS</a>
					</li>
					<li>
						<a class="active" href="piloto-search.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR PILOTO</a>
					</li>
				</ul>	
			</div>
			...
			<div class="container-fluid">
				...
				<?php
							...
							$url = 'http://localhost:8012/appwebservice/registro_piloto.php?licencia='. urlencode($_GET['licencia']);
