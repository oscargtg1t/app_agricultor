	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-search fa-fw"></i> &nbsp; CARGAMENTOS
				</h3>
			...
			<div class="container-fluid">
								<p class="text-center" style="font-size: 20px;">
									...
									<div class="text-left">
									<a href="cargamento-update.html" class="btn btn-success"><i class="fas fa-sync-alt"></i>&nbsp;Actualizar</a>
    								<button type="button" id="btdescargar" class="btn btn-success"><i></i>&nbsp;Descargar</button>
									</div> 
				<form  id="resultform" class="form-neon">
				<?php
							if (isset($_GET['id_cargamento'])) {
							$url = 'http://localhost:8012/appwebservice/registro_cargamento.php?id_cargamento='. urlencode($_GET['id_cargamento']);
